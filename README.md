...
as such:
  ...
  * cz.brmlab.yodaqa.annotator.* carries for each pipeline stage the annotators
    that contain actual algorithms that operate on the data, reading and
    generating CAS objects

...
for us.  For machine learning, we use a mix of ClearTK (wrapping CRFsuite)
and scikit-learn.  We also draw some inspiration from the OpenQA project
and the Taming Text book.
...
not at trivia questions, but the biomedical domain of the BioASQ
challenge at CLEF15 QA Labs.**

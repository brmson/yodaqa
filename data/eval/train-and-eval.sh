...
screen -m sh -c '
	screen "'"$baserepo"'/data/eval/_multistage_traineval.sh" "'"$baserepo"'" "qald5-train" 1 0 '"$basecid"';
	sleep 10;
	screen "'"$baserepo"'/data/eval/_multistage_traineval.sh" "'"$baserepo"'" "qald5-test" 0 1 '"$basecid"'
'

 ...
 * @generated */
public class ListItem_Type extends Annotation_Type {
  /** @generated 
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.ntcir.qalab.types.ListItem");
  ...
  public String getLabel(int addr) {
      ...
      jcas.throwFeatMissing("label", "edu.cmu.lti.ntcir.qalab.types.ListItem");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "edu.cmu.lti.ntcir.qalab.types.ListItem");
  ...
  public String getId(int addr) {
      ...
      jcas.throwFeatMissing("id", "edu.cmu.lti.ntcir.qalab.types.ListItem");

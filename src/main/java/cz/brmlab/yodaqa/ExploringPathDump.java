...
import cz.brmlab.yodaqa.io.debug.ExploringPathPrinter;
 ...
 */
public class ExploringPathDump {
	public static void main(String[] args) throws Exception {
		if (args.length != 2) {
			System.err.println("Usage: ExploringPathDump INPUT.{tsv,json} OUTPUT.json");
			System.err.println("Outputs the result of FBPathGloveScoring");
			System.exit(1);
		}
		...
		AnalysisEngineDescription printer = createEngineDescription(
				ExploringPathPrinter.class,
				ExploringPathPrinter.PARAM_JSONFILE, args[1],

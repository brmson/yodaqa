...
public class AnswerGSHook extends JCasAnnotator_ImplBase {
	...
	String featureBlacklist[] = {
        "originPsgByCluePhrase", "originPsgByClueSubjectNE", "originPsgByClueSubjectPhrase", "originPsgNPByLATSubj", "originBingSnippet", "originDBpOClueToken", "originDBpOCluePhrase", "originDBpOClueSV", "originDBpOClueNE", "originDBpOClueLAT", "originDBpOClueSubject", "originDBpOClueSubjectNE", "originDBpOClueSubjectToken", "originDBpOClueSubjectPhrase", "originDBpOClueConcept", "originDBpOConceptRR", "originDBpOConceptScore", "originDBpPClueToken", "originDBpPCluePhrase", "originDBpPClueSV", "originDBpPClueNE", "originDBpPClueLAT", "originDBpPClueSubject", "originDBpPClueSubjectNE", "originDBpPClueSubjectToken", "originDBpPClueSubjectPhrase", "originDBpPClueConcept", "originDBpPConceptRR", "originDBpPConceptScore", "originFBOClueToken", "originFBOCluePhrase", "originFBOClueSV", "originFBOClueNE", "originFBOClueLAT", "originFBOClueSubject", "originFBOClueSubjectNE", "originFBOClueSubjectToken", "originFBOClueSubjectPhrase", "originFBOClueConcept", "originFBOConceptRR", "originFBOConceptScore", "psgDistCluePhrase", "psgDistClueSubjectNE", "psgDistClueSubjectPhrase", "tyCorPassageSp", "tyCorPassageDist", "tyCorPassageInside", "LATQuantity", "tyCorADBpWN", "tyCorAQuantity", "tyCorADBpOntology", "tyCorADBpProperty", "tyCorAFBOntology", "clOCPrefixingScore", "clOCSuffixingScore", "clOCSubstringScore", "clOCMetaMatchScore", "clOMatchScore", "clOPrefixingScore", "clOSuffixingScore", "clOSubstringScore", "clOMetaMatchScore", "evdPrefixedScore", "evdPrefixingScore", "evdSuffixedScore", "evdSuffixingScore", "evdSubstredScore", "evdSubstringScore", "topAnswer", "solrHitsEv", "solrAHitsEv", "solrHitsANormEv", "solrMaxScoreEv", "solrHitsMaxScoreEv", "phase0Score", "phase1Score",
